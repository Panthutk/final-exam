...
class Polygon:
    def draw_polygon(self, num_sides, size, orientation, location, color, border_size):
        ...
        self.goto = turtle.goto(location[0], location[1])
        self.setheading = turtle.setheading(orientation)
        self.color = turtle.color(color)
        self.pensize = turtle.pensize(border_size)
...
Polygon.draw_polygon(num_sides, size, orientation,
                     location, color, border_size)
